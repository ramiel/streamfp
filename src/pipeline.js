 ...
 * `pipeline` is different from `compose` because it simply build a pipeline fo transformations that
 * can be composed again. `compose` do not support subcomposing and apply transformations directly
 */
